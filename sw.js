/* Service Worker — Defeso da Pesca em Roraima (versão adulta)
   Guarda o folder inteiro no aparelho no primeiro acesso com internet,
   para que os acessos seguintes funcionem mesmo offline.
   Para publicar uma atualização, troque a versão do CACHE (ex.: defeso-adulto-v2). */

const CACHE = 'defeso-adulto-v1';
...
const ESSENCIAIS = [
  ...
  './img/barco_hotel.jpg',
  './img/boto.jpg',
  './img/femarh_cipa_barcos.jpg',
  './img/femarh_cipa_queima.jpg',
  './img/inpa_peixeboi_rede1.jpg',
  './img/jaraqui.jpg',
  './img/jau.jpg',
  './img/matrinxa.jpg',
  './img/peixeboi.jpg',
  './img/pirarara.jpg',
  './img/pirarucu.jpg',
  './img/rio_caracarai.jpg',
  './img/ro_malhadeiras1.jpg',
  './img/ro_malhadeiras2.jpg',
  './img/surubim.jpg',
  './img/tambaqui.jpg',
  './img/tartaruga.jpg',
  './img/tucunare.jpg',
